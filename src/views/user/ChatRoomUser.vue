    ...
    <div class="content-room-chat mt-3">
      <div class="top-room-chat d-flex">
        <div class="rigth-top-room">
          <div class="wrapper-photo">
            <img :src="getUser.avatar" alt="Photo Staff" @error="imgPlaceholder">
          </div>
        </div>
      ...
      <div class="bottom-chat-room">
        <div class="wrapper-input-message">
          <input type="text" v-model="inputMessage" placeholder="please input message . . ." @keypress.enter="handleSendMessage">
...
export default {
  ...
  methods: {
    ...
    handleSendMessage () {
      ...
      this.historyMessages.push(this.inputMessage)
      this.inputMessage = ''
    },
  ...
  computed: {
    ...mapGetters(['getUser', 'getHistoryChat'])
  }
}
</script>
